...
ogr2ogr -f "GeoJSON"  -s_srs 'EPSG:32633' -t_srs 'EPSG:4326' ../public/data/schools.json schools.gml
...
ogr2ogr -f "GeoJSON"  -s_srs 'EPSG:32633' -t_srs 'EPSG:4326' ../public/data/school_boundaries.json school_boundaries.gml
